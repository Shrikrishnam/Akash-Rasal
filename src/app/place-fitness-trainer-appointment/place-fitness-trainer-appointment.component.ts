...
export class PlaceFitnessTrainerAppointmentComponent implements OnInit {
  ...
  ngOnInit() {
      if(!this.userService.userData){
        ...
        this.initializeForm(this.tempData.firstname,this.tempData.lastname,this.tempData.phonenumber,this.tempData.email,
            this.tempData.inr,this.tempData.paisa,this.tempData.streetaddress,this.tempData.city,this.tempData.state,this.tempData.country,
            this.tempData.pincode,this.tempData.age,this.tempData.trainerpreference,this.tempData.physiotherapist,this.tempData.packages);
        this.userService.userData = undefined;
      }
  }

  initializeForm(passfirstname, passlastname, passphno, passemail, passinr, passpaisa, passstreetadd, passcity, passstate,
         passcountry, passpincode, passage, passtrainerpreference, passphysiotherapist, passpackages){
     ...
     email: [passemail, [Validators.required,Validators.pattern("[^ @]*@[^ @]*")]],
  ...
  onSubmit() {
        ...
        if (this.fitnessForm.valid && !this.updateFlag) {
            ...
            this.userService.updatefitnessdata(this.updateId,this.fitnessForm.value).subscribe(res => {
